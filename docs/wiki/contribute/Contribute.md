Contributions are welcome on this project. We distribute under the terms of the [Apache 2.0 license](https://github.com/csp-benchmarks/csp-benchmarks/blob/main/LICENSE).

> [!NOTE]
>
> `csp-benchmarks` requires [Developer Certificate of Origin](https://en.wikipedia.org/wiki/Developer_Certificate_of_Origin) for all contributions.
...
For **bug reports** or **small feature requests**, please open an issue on our [issues page](https://github.com/csp-benchmarks/csp-benchmarks/issues).

For **questions** or to discuss **larger changes or features**, please use our [discussions page](https://github.com/csp-benchmarks/csp-benchmarks/discussions).
