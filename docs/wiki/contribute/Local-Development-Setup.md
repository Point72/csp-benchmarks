...
To work on `csp-benchmarks`, you are going to need to build it from source. See
[Build from Source](Build-from-Source) for
detailed build instructions.

Once you've built `csp-benchmarks` from a `git` clone, you will also need to
configure `git` and your GitHub account for `csp-benchmarks` development.

## Step 2: Configuring Git and GitHub for Development

### Create your fork

The first step is to create a personal fork of `csp-benchmarks`. To do so, click
the "fork" button at https://github.com/csp-benchmarks/csp-benchmarks, or just navigate
[here](https://github.com/csp-benchmarks/csp-benchmarks/fork) in your browser. Set the
...
main csp-benchmarks repository and your fork. See the [GitHub Docs](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/configuring-a-remote-repository-for-a-fork) for more information.
